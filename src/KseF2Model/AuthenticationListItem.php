...
/**
 * AuthenticationListItem Class Doc Comment
 *
 * @package  NetSeven
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AuthenticationListItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AuthenticationListItem';
    ...
    */
    ...
    public function setReferenceNumber(string $reference_number): static
    {
        ...
        if ((mb_strlen($reference_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $reference_number when calling AuthenticationListItem., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($reference_number) < 36)) {
            throw new InvalidArgumentException('invalid length for $reference_number when calling AuthenticationListItem., must be bigger than or equal to 36.');
        }
